<x-layout>
    ...
    <x-slot:page_content>
        <div class='flex justify-center items-center h-[4rem]'>
            <h1 class='text-4xl text-gray-300'>Создание вакансии</h1>
        </div>
        ...
        <form class="mt-6"
            ...
            <div class="space-y-12">
                <div class="border-b border-gray-100/10 pb-12">
                    <h2 class="text-base/7 font-semibold text-gray-100 tracking-wider">Создать новую
                        вакансию</h2>
                    <p class="mt-1 text-sm/6 text-gray-300 tracking-wide">Нам просто нужно немного
                        подробностей от
                        вас.</p>
