...
return [
    ...
    // ? Это используется в стандартных сообщениях Laravel (без кастомных).
    'attributes' => [
        'address' => 'адрес',
    ...
    // ? Кастомные правила (custom) перекрывают дефолтные.
    'custom' => [
        'job_title' => [
            'required' => 'Укажите название вакансии!',
            'min' => 'Название вакансии не должно содержать меньше :min символов.',
            'max' => 'Название вакансии не должно превышать :max символов.',
        ],
        'salary' => [
            'required' => 'Введите зарплату!',
            'min' => 'Заработная плата не должна содержать меньше :min символов.',
            'max' => 'Заработная плата не может содержать больше :max символов.',
        ],
    ],
];
